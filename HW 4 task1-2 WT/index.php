...
$works = [
    [
        ...
        "description" => "Тут описание работы инженером-проектировщиком тут описание работы инженером-проектировщиком тут описание работы инженером-проектировщиком",
    ],
    [
      "name" => "Ведущий менеджер по продажам",
      "dateStart" => "Январь 2004",
      "dateEnd" => "Январь 2007",
      "description" => "Тут описание работы кондитером тут описание работы кондитером тут описание работы кондитером",
    ],
    [
      "name" => "Младший менеджер по продажам",
      "dateStart" => "Январь 2000",
      "dateEnd" => "Январь 2004",
      "description" => "Тут описание работы финансового директора тут описание работы финансового директора тут описание работы финансового директора",
    ],
];
